...
int bit_vec_filter_m128_sse2(uint8_t *read_vec0, uint8_t *read_vec1, uint8_t
				*ref_vec0, uint8_t *ref_vec1, __m128i mask, int max_error) {
...
int bit_vec_filter_sse2(char* read, char* ref, int length, int max_error) {
	//Get ready the bits
	sse3_convert2bit1(read, read_vec0_t, read_vec1_t);
	sse3_convert2bit1(ref, ref_vec0_t, ref_vec1_t);
	...
	return bit_vec_filter_m128_sse2(read_vec0_t, read_vec1_t,
					ref_vec0_t, ref_vec1_t, mask, max_error);
}
...
int bit_vec_filter_sse1_ex2(char* read, char* ref, int read_len, int ref_len, int max_error){

	sse3_convert2bit1(read, read_vec0_t, read_vec1_t);
	sse3_convert2bit1(ref, ref_vec0_t, ref_vec1_t);
	if(bit_vec_filter_m128_sse1_ex(read_vec0_t, read_vec1_t,
					ref_vec0_t, ref_vec1_t, read_len, ref_len, max_error))
					{
						return bit_vec_filter_m128_sse1_ex(ref_vec0_t, ref_vec1_t,
										read_vec0_t, read_vec1_t, ref_len, read_len, max_error);
					}
	return 0;
}
